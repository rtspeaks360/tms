...
class Student(restful.Resource):
	def post(self):
...
class Vehicle(restful.Resource):
	def post(self):
		...
		if args['perform_action'] = 'delete_vehicle':
			...
			session.commit()
			return jsonify(message = "Vhicle Deleted")
...
api.add_resource(Vehicle, 'v1/vehicle')
...
api.add_resource(Route, 'v1/route')
...
api.add_resource(Driver,'/v1/driver')
